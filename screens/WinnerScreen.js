...
import {
  ImageBackground, SafeAreaView, StyleSheet, View, Text, Image,
} from 'react-native';
...
export default function WinnerScreen({ navigation }) {
  const {
    resetGame, player1Name, player2Name, player1Score, player2Score, winner,
  } = useContext(GameContext);

  let winnerName; let winnerScore; let runnerUpName; let runnerUpScore; let
    isDraw;
    ...
    <ImageBackground style={styles.background} source={require('../assets/Wallpaper.png')}>
      ...
      <View style={styles.viewContent}>
        ...
        <View style={{ flexDirection: 'row', marginVertical: 20, height: 80 }}>
          ...
          <View style={{
            flex: 5, flexDirection: 'row', backgroundColor: '#FFD975', alignItems: 'center', justifyContent: 'space-around', borderRadius: 5,
          }}
          >
        ...
        <View style={{ flexDirection: 'row', marginBottom: 20, height: 80 }}>
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} />
          <View style={{
            flex: 5, flexDirection: 'row', backgroundColor: 'white', alignItems: 'center', justifyContent: 'space-around', borderRadius: 5,
          }}
          >
