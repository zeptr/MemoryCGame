...
import {
  ImageBackground, StyleSheet, View, Text, Image, Dimensions,
} from 'react-native';
...
export default function GameScreen({ navigation }) {
  const {
    cards, initializeGame, resetGame, player1Name, player2Name, player1Score, player2Score, isPlayer1Turn, isGameActive, winner,
  ...
  return (
    <ImageBackground style={styles.background} source={require('../assets/Wallpaper.png')}>
      ...
      <View style={styles.topContainer}>
        ...
        <View style={{
          flex: 2, justifyContent: 'flex-end', alignItems: 'center', paddingTop: 15,
        }}
        >
          <Text style={styles.mainText}>Memory</Text>
        </View>
        <View style={{
          flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingTop: 15,
        }}
        >
